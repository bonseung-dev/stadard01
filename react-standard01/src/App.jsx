  ...
  return (
    <>
      ...
      <form onSubmit={addUser}>
        ...
        <input type="number" value={age} placeholder="나이" onChange={(e) => {
      ...
      <ul>
        ...
        {users.map((user) => {
          return <li key={user.id} style={{listStyle : "none"}}>이름 : {user.name}, 나이 : {user.age} <button onClick={()=>removeUser(user)}>삭제</button></li>
        })}
      </ul>
    </>
  );
